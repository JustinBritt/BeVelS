namespace BeVelS.Graphics.BufferConstants.Factories.VertexConstants
{
    ...
    internal sealed class TriangleVertexConstantsFactory : ITriangleVertexConstantsFactory
    {
        private ILog Log => LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public TriangleVertexConstantsFactory()
        {
        }

        public TriangleVertexConstants Create(
        ...
        {
            TriangleVertexConstants vertexConstants = default;
