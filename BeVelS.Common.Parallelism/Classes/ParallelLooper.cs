namespace BeVelS.Common.Parallelism.Classes
{
    using System;
    ...
    [BepuPhysicsLicensedCode(
        ...
        source: "https://github.com/bepu/bepuphysics2/blob/master/DemoRenderer/ParallelLooper.cs",
    ...
    public delegate void LooperAction(
        int jobIndex,
        int workerIndex);
    ...
    public delegate void LooperWorkerDone(
        int workerIndex);
    ...
    public class ParallelLooper : IParallelLooper
    {
            ...
            LooperWorkerDone workerDone = null)
        {
            ...
            else
            {
                ...
                this.Dispatcher.DispatchWorkers(
                    this.dispatcherWorker,
                    exclusiveEnd - start);
