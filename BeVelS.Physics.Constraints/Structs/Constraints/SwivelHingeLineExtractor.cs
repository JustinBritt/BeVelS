namespace BeVelS.Physics.Constraints.Structs.Constraints
{
    ...
    [BepuPhysicsLicensedCode(
        ...
        source: "https://github.com/bepu/bepuphysics2/blob/master/DemoRenderer/Constraints/SwivelHingeLineExtractor.cs",
        BepuPhysicsLicensedCodeAttribute.FormattingChanges,
        "Use ColorUtilities")]
    public struct SwivelHingeLineExtractor : IConstraintLineExtractor<SwivelHingePrestepData>
    {
        public int LinesPerConstraint => 5;

        public unsafe void ExtractLines(
            ref SwivelHingePrestepData prestepBundle,
            int setIndex,
            int * bodyIndices,
            Bodies bodies,
            ref Vector3 tint,
            ref QuickList<LineInstance> lines)
        {
            ...
            lines.AllocateUnsafely() = new LineInstance(
                jointAnchorA,
                jointAnchorA + 0.2f * swivelAxis,
                packedAxisColor,
                0);
            
            lines.AllocateUnsafely() = new LineInstance(
                jointAnchorB,
                jointAnchorB + 0.2f * hingeAxis,
                packedAxisColor,
                0);
