namespace BeVelS.Physics.Constraints.Structs.Constraints
{
    ...
    public struct Contact3NonconvexOneBodyLineExtractor : IConstraintLineExtractor<Contact3NonconvexOneBodyPrestepData>
    {
        public int LinesPerConstraint => 6;

        public unsafe void ExtractLines(
            ref Contact3NonconvexOneBodyPrestepData prestepBundle,
            int setIndex,
            int * bodyIndices,
            Bodies bodies,
            ref Vector3 tint,
